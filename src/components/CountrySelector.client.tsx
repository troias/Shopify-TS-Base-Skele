    ...
    return (
        <div className="relative" >
            <Listbox onChange={setCountry}>
                ...
                <>
                                <Listbox.Button
                                    className={`flex items-center justify-between w-full py-3 px-4 border ${open ? 'rounded-b md:rounded-t md:rounded-b-none' : 'rounded'
                ...
                md:border-t-0 md:border-b ${listboxOpen ? 'max-h-48' : 'max-h-0'
                                        }`
                                    }
                                >
                                    {listboxOpen && (
        ...
        getClassName = {(active) => {
            return `text-contrast dark:text-primary bg-primary 
                        ...
                        flex justify-start items-center text-left cursor-pointer ${active ? 'bg-primary/10' : null
                }`
        }
    }
    />
